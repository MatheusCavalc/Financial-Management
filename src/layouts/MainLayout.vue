...
const props = defineProps(['namePage'])
...
<template>
    <div :class="{ 'overflow-hidden': open1, '': !open1 }">
            ...
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        <button @click="open1 = !open1" data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
        ...
        <aside id="logo-sidebar" :class="{ 'transform-none': open1, '-translate-x-full': !open1 }"
            ...
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="/admin/sneakers" wire:navigate
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 18 18">
                    ...
                    <li>
                        <a href="/admin/orders" wire:navigate
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">My Files</span>
                        </a>
                    </li>

                    <li class="bg-gray-500 text-white">
                        <p class="ml-2 text-sm">Recommends</p>
                    </li>
                    ...
                    <li>
                        <a href="#"
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Most Popular</span>
                        </a>
                    </li>
                    <li>
                        <RouterLink :to="{ name: 'Home' }"
        ...
        <div v-show="open1" @click="open1 = !open1" class="bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-30">
        </div>
    </div>
